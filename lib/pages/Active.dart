...
class ActivePersons extends StatelessWidget {
  int index;
  ActivePersons({required this.index, super.key});

  @override
  Widget build(BuildContext context) {
    final HiveController hiveController = Get.find();
    ImageProvider image() {
      if (hiveController.ReadActivePerson(index).image!.isEmpty) {
        return const AssetImage("assets/25.png");
      } else {
        return FileImage(File(hiveController.ReadActivePerson(index).image!));
      }
    }
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        "${hiveController.ReadActivePerson(index).name}",
                        style: TextStyle(
                          color: Colors.black,
                          fontSize: 12.7.sp,
                          fontFamily: 'Helvetica',
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        "${hiveController.ReadActivePerson(index).phone}",
                        style: TextStyle(
                          color: Colors.black,
                          fontSize: 12.5.sp,
                          fontFamily: 'Helvetica',
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        "${hiveController.ReadActivePerson(index).plan}",
                        style: TextStyle(
                          color: Colors.black,
                          fontSize: 12.5.sp,
                          fontFamily: 'Helvetica',
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        '${hiveController.ReadActivePerson(index).experation.day}/${hiveController.ReadActivePerson(index).experation.month}/${hiveController.ReadActivePerson(index).experation.year}',
                        style: TextStyle(
                          color: Colors.black,
                          fontSize: 12.5.sp,
                          fontFamily: 'Helvetica',
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Container(
                            child: Text(
                              '${hiveController.ReadActivePerson(index).paid} DZD',
                              style: TextStyle(
                                color: Colors.black,
                                fontSize: 12.5.sp,
                                fontFamily: 'Helvetica',
                                    ...
                                    Container(
                                      ...
                                      child: TextButton(
                                          ...
                                          onPressed: ()async {
                                            ...
                                            if (hiveController.ReadActivePerson(
                                                        index)
                                                    .image !=
                                                null) {
                                            await  deleteImage(hiveController
                                                      .ReadActivePerson(index)
                                                  .image!);
                                            }

                                            hiveController.DeleteActivePerson(
                                                index);
